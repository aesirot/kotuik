...
public class RpcExampleApplication {
    ...
    public static void main(final String[] args) {
        ...
        try (final ZmqTcpQluaRpcClient rpcClient = ZmqTcpQluaRpcClient.newInstance(config)) {
            ...
            //GetQuoteLevel2.Args args2 = GetQuoteLevel2.Args.builder().classCode("TQBR").secCode("TGKD").build();

            //GetQuoteLevel2.Result result = rpcClient.qlua_getQuoteLevel2(args2);
            if (result == null) {

    ...
    public ResponseEnvelope deserialize(final JsonParser p, final DeserializationContext ctxt) throws IOException {
        ...
        if (errorNode != null) {
            ...
            if (resultNode == null) {
                ...
                //ANTON result = ResponseEnvelope.withResult( resultNode.toString().getBytes(StandardCharsets.UTF_8) );
                result = ResponseEnvelope.withResult( resultNode.toString().getBytes(Charset.forName("CP1251")) );
            }
        }
